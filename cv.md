...
Father of four, with a **"can do" attitude** to work and life.
...
Understand practices and motivations to produce **better solutions**.
Innovate solutions for old problems to **stay relevant** and competitive.



**Key Skills**

**Mindful design** and development, adhering to web standards.
...
**Company:** Happity ([https://happity.co.uk](https://happity.co.uk/))
**Dates:** 2025 - Present
...
**Technologies/Languages:** Python, Go, Ruby, Lua, HTML, HAML, XML, CSS, JavaScript, CoffeeScript, TypeScript, Redis, Couchbase, PostgreSQL, MySQL, ffmpeg
**Frameworks/Libraries:** Ruby on Rails, Vue, jQuery, AngularJS, Bootstrap, RSpec, Ginkgo, Turnip, Databricks

**Company:** Rehearse.app (side project)
**Dates:** December 2014 - Current
**Position:** Solo Dev
**Overview:**
...
Unfortunately my wife was driving the project internally and she went on maternity leave halfway through, so while it did help, it never quite got used to its full capacity. It did get a mention in the RCPsych newsletter and a year later when she came back onto the project the RCPsych had built their own version, so I hope it helped in some way. The project, dubbed Accredit, is still up at [https://aimsadmin.app](https://aimsadmin.app) with a demo organisation (please ask for demo access), recently updated to Rails 7 and deployed with Kamal 2.

**Technologies/Languages:** Ruby, HTML, CSS, JavaScript, PostgreSQL, Kamal 2
**Frameworks/Libraries:** Ruby on Rails, Hotwire (Turbo, Stimulus), Bootstrap, RSpec, Kamal 2

**Company:** Rawnet (https://www.rawnet.com)
**Dates:** April 2010 - February 2012
**Position:** Lead Web Developer
**Overview:**

Rawnet is an agency, consequently there was great variety in the projects that were commissioned.
The following is a sample of the longer-running projects where my role was Lead Developer or Co-lead Developer.

* Britain's Advanced Mainstream (BAM) - A service that shares attitudes and behaviours of tech-users with media industry subscribers
* BBC Insight - The forerunner to BAM; Essentially BAM just for the BBC. (I took this project on and rebuilt it as the multi-tenant app BAM)
* OWL Group (50Connect.co.uk/OlderIsWiser.com) - Multi-tenant Article and Forum based social network for the older generation.
* LoveThis.com - Recommendation engine/app (now externally developed)
...
**Technologies/Languages:** Ruby, HTML, HAML, XML, CSS, JavaScript, CoffeeScript, MySQL
**Frameworks/Libraries:** Ruby on Rails, jQuery, BackboneJS, RSpec, Cucumber, Titanium

**Company:** AOL Advertising ([http://advertising.aol.co.uk/](http://advertising.aol.co.uk/))
**Dates:** September 2007 - February 2010
...
These applications included; Email based request queuing and creative testing services (decompiling flash files and checking click tags, parsing html and JavaScript page inserts for malware and verifying image file metadata); Large scale, client facing, multi-lingual REST based reporting services (both Service and Client); Company Sales Dashboard (Service - RoR, Client - Flex) showing graphs/charts.

**Technologies/Languages:** Ruby, Actionscript 3 (Flex), HTML, XML, CSS, JavaScript, JSON, MySQL
**Frameworks/Libraries:** Ruby on Rails, Metal, Prawn, RubyNetLdap, RetoI18n, Flex Charting, OpenFlashCharts, Blueprint CSS, Prototype JS, Plexigrid ([https://github.com/dim/plexigrid](https://github.com/dim/plexigrid)), jQuery, RSpec, Cucumber, TestSpec

**Company:** Debatewise ([https://debatewise.org/](https://debatewise.org/))
**Dates:** 2006 - September 2007
...
**Technologies/Languages:** Ruby, HTML, CSS, JavaScript
**Frameworks/Libraries:** Ruby on Rails, Prototype JS, RSpec
**Part-Time Experience**

While at college I volunteered to coach music students through my Local Education Authority (LEA). This allowed me to develop the skills to interact well with people, especially under stressful conditions (think: a classroom full of screaming children early on a Saturday morning, without the aid of coffee). It has been a grounding factor in my life and work ever since, allowing me to work more effectively and passionately on projects that I undertake.

**Education**

*UCE Birmingham (now Birmingham City), Technology Innovation Centre/The Birmingham Conservatoire*
BSc Music Technology 2:2 (59%, a year early)
Extra-curricular short courses including
\* Database Design
...
*The New Technology Institute (NTI) Birmingham*
Apple Accredited Final Cut Pro for Professional Editors (97%)

**More Personal Details**

**Gender:** Male
**D.O.B:** 29/03/1986
**Email:** [hireme@ajneill.dev](mailto:hireme@ajneill.dev)
**Website:** [https://ajneill.dev/](https://ajneill.dev/)
**Github:** [https://github.com/ajn](https://github.com/ajn)
**Gitlab:** [https://gitlab.com/ajn](https://gitlab.com/ajn)
**Misc:** Full UK Clean Driving Licence